          ...
          >
            <div className="group relative h-full overflow-hidden rounded-2xl border border-border bg-background transition duration-200 hover:shadow-xl">
              ...
              <div className="p-4 flex flex-col h-full">
                ...
                <div className="mb-1 md:mb-2 flex flex-wrap gap-3">
                ...
                {/* Boutons */}
                <div className="mt-5 md:justify-around flex gap-3 justify-end">
                  <a
                    href={project.demo}
                    target="_blank"
                  ...
                  >
                    ...
                    <span className="hidden md:block">Browse Project</span>
                  </a>
                  <a
                    href={project.github}
                    target="_blank"
